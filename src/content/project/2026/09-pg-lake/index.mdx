...
date: 2026-03-23
tags: ["data-engineering", "apache-iceberg", "snowflake", "postgresql", "lakehouse"]
category: "projects"
readTime: "11 min"
summary: "How to build a true lakehouse architecture where Snowflake Postgres writes transactional data directly to Apache Iceberg on S3 — with no ETL pipelines, no COPY INTO, and no data duplication — while Snowflake reads the same files for analytics."
image: "./thumbnail-pg-lake.png"
draft: false
---
