...
> Built scalable distributed data processing system on AWS EMR handling large-scale financial datasets with PySpark, achieving 40% cost reduction through spot instances.
