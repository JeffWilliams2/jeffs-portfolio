...
- <LinkWithLabel label="Architecture Diagram" href="https://github.com/yourusername/realtime-banking-cdc-pipeline/blob/main/docs/architecture.png" title="Detailed system architecture" />
